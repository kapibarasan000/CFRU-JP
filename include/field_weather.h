...
void __attribute__((long_call)) sub_807A7D0(void);
...
void __attribute__((long_call)) sub_807A3C0(void);
void __attribute__((long_call)) sub_807A3F8(void);
void __attribute__((long_call)) SetRainStrengthFromSoundEffect(u16 soundEffect);
void __attribute__((long_call)) sub_8079EF0(s8 gammaIndex);
void __attribute__((long_call)) sub_8079F24(u8 gammaIndex, u8 gammaTargetIndex, u8 gammaStepDelay);
