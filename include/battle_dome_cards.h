...
bool16 __attribute__((long_call)) dp13_810C664(void);
...
u8 __attribute__((long_call)) sub_810CD7C(u16, u8, s16, s16, u8, u16);
void __attribute__((long_call)) sub_810CDC0(u16);
