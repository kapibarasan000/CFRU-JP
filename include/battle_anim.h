...
void __attribute__((long_call)) sub_80A7F28(u8 arg0);
u8 __attribute__((long_call)) GetAnimBankSpriteId(u8 wantedBank);
bool8 __attribute__((long_call)) IsDoubleBattle(void);
u8 __attribute__((long_call)) sub_80A8054(void);
u8 __attribute__((long_call)) sub_80A9624(u8);
...
u8 __attribute__((long_call)) sub_80A95A4(u8 bank);
...
void __attribute__((long_call)) SpriteCB_80BBA7C(struct Sprite *sprite);
