...
/*u16*/ #define sTrainerBattleMode (*((u16*) 0x20385E0))
/*u16*/ #define gTrainerBattleOpponent_A (*((u16*) 0x20385E2))
		#define sTrainerEventObjectLocalId (*((u16*) 0x20385E4))
		#define sTrainerIntroSpeech_A (*((u8**) 0x20385E8))
		#define sTrainerDefeatSpeech_A (*((u8**) 0x20385EC))
		#define sTrainerVictorySpeech (*((u8**) 0x20385F0))
		#define sTrainerCannotBattleSpeech (*((u8**) 0x20385F4))
		#define sTrainerBattleEndScript (*((u8**) 0x20385F8))
		#define sTrainerBattleScriptRetAddr (*((u32*) 0x20385FC))
		#define sTrainerBattleOakTutorialHelper (*((u16*) 0x2038600))


#define gBattleStringLoader (*((const u8**) 0x203DF98))
#define gSeedHelper ((u8*) 0x203DF9C)
#define gTerrainType *((u8*) 0x203DFA0)
#define gFormCounter *((u8*) 0x203DFA1)
#define gPoisonedBy *((u8*) 0x203DFA2)
