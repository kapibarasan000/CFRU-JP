...
const struct SpecificTilesetFade gSpecificTilesetFades[] =
{
	...
	{ //Palette Town - Player's Door
		.tilesetPointer = 0x8298B5C, //Tileset 1
		.paletteNumToFade = 8,
...
const struct SpecificTilesetFade gSpecificTilesetFades[] =
{
	...
	{ //Bellin Town Lamp
		.tilesetPointer = 0x8298B74, //Tileset 2
		.paletteNumToFade = 9,
		.paletteIndicesToFade =
		{
			{3,  RGB(31, 30, 1)},
	...
	{ //Main Pokemon Centre Windows
		.tilesetPointer = 0x8298B44, //Tileset 0
		.paletteNumToFade = 2,
		.paletteIndicesToFade =
		{
			{7,  RGB(31, 31, 14)},
	...
	*/
	/*{ //Dresco Town Moltres - Issue: Lights up bench too :(
		.tilesetPointer = 0x8298BA4, //Tileset 4
		.paletteNumToFade = 7,
		.paletteIndicesToFade =
		{
	...
	{ //Crater Town House Windows
		.tilesetPointer = 0x8298B8C, //Tileset 3
		.paletteNumToFade = 7,
		.paletteIndicesToFade =
		{
			{4,  RGB(31, 31, 14)},
	...
	{ //Tarmigan House Windows
		.tilesetPointer = 0x8298C1C, //Tileset 9
		.paletteNumToFade = 7,
		.paletteIndicesToFade =
		{
			{15, RGB(31, 31, 14)},
	...
	{ //Dehara City Game Corner
		.tilesetPointer = 0x8298BEC, //Tileset 7
		.paletteNumToFade = 8,
		.paletteIndicesToFade =
		{
			{5,  RGB(14, 23, 26)},
	...
	{ //Gurun Town House Window
		.tilesetPointer = 0x8298BD4, //Tileset 6
		.paletteNumToFade = 8,
		.paletteIndicesToFade =
		{
			{14, RGB(31, 31, 14)},
	...
	{ //Vivill Town House Windows
		.tilesetPointer = 0x8299114, //Tileset 62
		.paletteNumToFade = 7,
		.paletteIndicesToFade =
		{
			{13, RGB(31, 31, 20)},
	...
	{ //Antisis City House Windows
		.tilesetPointer = 0x8298BBC, //Tileset 5
		.paletteNumToFade = 7,
		.paletteIndicesToFade =
		{
			{14, RGB(31, 31, 14)},
	...
	{ //Antisis Port Lighthouse
		.tilesetPointer = 0x829915C, //Tileset 65
		.paletteNumToFade = 10,
		.paletteIndicesToFade =
		{
			{13, RGB(31, 30, 1)},
	...
	{ //Battle Tower
		.tilesetPointer = 0x8298EEC, //Tileset 39
		.paletteNumToFade = 7,
		.paletteIndicesToFade =
		{
			{1,  RGB(31, 27, 5)},
	...
	{ //Seaport City Windows
		.tilesetPointer = 0x8298CDC, //Tileset 17
		.paletteNumToFade = 7,
		.paletteIndicesToFade =
		{
			{12,  RGB(31, 31, 20)},
	...
	{ //Seaport City Port
		.tilesetPointer = 0x8298D0C, //Tileset 19
		.paletteNumToFade = 8,
		.paletteIndicesToFade =
		{
			{1,  RGB(8, 18, 20)},
	...
	{ //Polder Town
		.tilesetPointer = 0x8298C04, //Tileset 8
		.paletteNumToFade = 12,
		.paletteIndicesToFade =
		{
			{1,  RGB(31, 31, 20)},
	...
	{ //Magnolia Town Windows
		.tilesetPointer = 0x8298DB4, //Tileset 26
		.paletteNumToFade = 8,
		.paletteIndicesToFade =
		{
			{1,  RGB(31, 31, 14)},
	...
	{ //Redwood Village Windows
		.tilesetPointer = 0x8298EA4, //Tileset 36
		.paletteNumToFade = 10,
		.paletteIndicesToFade =
		{
			{1,  RGB(31, 31, 20)},
