...
// DEFINES
#define sSearchLevels ((u8*) 0x203C6D4)
...
static const struct SpriteSheet sCursorSpriteSheet = {(void*) 0x839B0F4, (32 * 32 * 4) / 2, SELECTION_CURSOR_TAG};
static const struct SpritePalette sCursorSpritePalette = {(void*) 0x8396CF8, SELECTION_CURSOR_TAG};
...
#endif
const struct SpriteSheet gHeldItemSpriteSheet = {(const u8*) 0x8419B3C, (8 * 16) / 2, GFX_TAG_HELD_ITEM};
const struct SpritePalette gHeldItemSpritePalette = {(const u16*) 0x08419B7C, GFX_TAG_HELD_ITEM};
