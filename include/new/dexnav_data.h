...
static const struct SpriteSheet sHeldItemSpriteSheet = {(const u8*) 0x8419B3C, (8 * 16) / 2, 0x8472};
static const struct SpritePalette sHeldItemSpritePalette = {(const u16*) 0x08419B7C, 0x8472};
