...
/*u32*/ #define gTrainerId 				*((u32*) 0x2020000)
		...
		#define gWindows ((struct Window*) 0x2020430)
...
///*u8*/  #define gStringVar4 ((u8*) 0x2021D18)
		...
		#define ColorFilter *((u8*)0x2036D5C)

		#define gWarp1 ((struct WarpData*) 0x2031CF0)

		#define gPlayerAvatar ((struct PlayerAvatar*) 0x02036FAC)

		#define gBoxStatusAndType ((u8*) 0x02036FD0)

/*u8*/  #define gUnknown_2023F65 ((u8*) 0x2023F65) //Length 0x3
/*u8*/  #define gUnknown_2023F68 ((u8*) 0x2023F68) //Length 0x10

/*u8*/  //#define sLearningMoveTableID *((u8*) 0x2024028)
/*u8*/  #define gPlayerPartyCount *((u8*) 0x2023F89)
/*u8*/  #define gEnemyPartyCount *((u8*) 0x2023F8A)

/*u8*/  #define gMultiuseSpriteTemplate ((struct SpriteTemplate*) 0x202443C)
...
/*u8*/  #define gPlttBufferUnfaded ((u16*) 0x203712C)
/*u8*/  #define gPlttBufferUnfaded2 ((u16*) 0x203732C)
/*u8*/  #define gPlttBufferFaded ((u16*) 0x203752C)
/*u8*/  #define gPlttBufferFaded2 ((u16*) 0x203772C)

/*u8*/  #define gPaletteFade ((struct PaletteFadeControl*) 0x20379EC)
/*u32*/	#define sPlttBufferTransferPending (*((u32*) 0x20379FC))

		#define gWeatherPtr ((struct Weather*) 0x2037E68)

/*u8*/  #define sPaletteGammaTypes ((u8*) 0x20385D8)
		extern u16 gScanlineEffectRegBuffers[2][0x3C0];

		//#define gEncounterRate ((struct EncounterRate*) 0x20386D0)
		#define sWildEncountersDisabled (*((u8*) 0x2038628))
...
/*u8*/  #define gBattlePartyCurrentOrder ((u8*) 0x203B050)
		...
		#define PalTagsStart *((u8*)0x3003E98)

		#define PalTags ((u16*)0x3000DE8)

		#define gMultiuseListMenuTemplate ((struct ListMenuTemplate*) ((u32*) 0x3005EC0))
...
//		#define gNumberOfMovesToChoose (*((u8*) 0x3004FF8))
		...
		#define gOverworldTilemapBg3 (*((u32*) 0x300505C))

/*u8*/  #define gSelectedEventObject (*((u8*) 0x30050B4))
...
/*u8*/  #define gStringVar7 ((u8*) 0x2022B24)	//32 bytes					//Buffer 0x5 	//FD 07
/*u8*/  #define gStringVar8 ((u8*) 0x2022B44)	//32 bytes					//Buffer 0x6	//FD 08
/*u8*/  #define gStringVar9 ((u8*) 0x2022B64)	//32 bytes					//Buffer 0x7	//FD 09
/*u8*/  #define gStringVarA ((u8*) 0x2022B84)	//32 bytes					//Buffer 0x8	//FD 0A
/*u8*/  #define gStringVarB ((u8*) 0x2022BA4)	//32 bytes					//Buffer 0x9	//FD 0B
/*u8*/  #define gStringVarC ((u8*) 0x2022BC4)	//100 bytes					//Buffer 0xA	//FD 0C
/*u8*/  #define gStringVarD ((u8*) 0x2022C28)	//100 bytes (to 0x2022D2C)	//Buffer 0xB	//FD 0D
...
#define gCreateSpriteTableSetter 0x203B725  // allow createsprite to load from a table as well
#define gTimerValue (*(u16*) 0x203B726)
//#define gKeypadSetter ((struct KeypadSetter*) 0x203B7B0)	//12 bytes
//#define gPedometers ((struct Pedometers*) 0x203B7BC)		//12 bytes
#define gWalkingScript (*((const u8**) 0x203B740))

// Dynamic Overworld Palettes
//#define sPalRefs ((PalRef*) 0x203B7D4)	// 16 sprites * 4 bytes each = 0x40 bytes

#define gPlayerCoins (*((u32*) 0x203B78C))
...
#define gFishingByte *((u8*) 0x203DFC0)
#define gLastRecordedFadeCoeff (*((u8*) 0x203DFC1))
#define gLastRecordedFadeColour (*((u16*) 0x203DFC2))
