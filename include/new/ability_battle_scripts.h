...
extern const u8 BattleScript_ParadoxAbilityActivates[];
extern const u8 BattleScript_ParadoxAbilityActivatesRet[];
extern const u8 BattleScript_ParadoxAbilityEnd[];
extern const u8 BattleScript_ParadoxAbilityEndRet[];
extern const u8 BattleScript_TeraShiftActivates[];
extern const u8 BattleScript_OpportunistCopyStatChange[];
extern const u8 BattleScript_OpportunistCopyDragonCheer[];
extern const u8 BattleScript_OpportunistEnd[];
...
extern const u8 BattleScript_TeraShellActivate[];
...
extern const u8 gText_RuinAbilityActivate[];
...
extern const u8 gText_BoosterEnergyActivate[];
