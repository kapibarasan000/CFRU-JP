...
extern const u8 BattleScript_EmbodyAspect[];
...
extern const u8 gText_OrichalcumPulseSunActivate[];
extern const u8 gText_OrichalcumPulseActivate[];
...
extern const u8 gText_HadronEngineSetString[];
extern const u8 gText_HadronEngineActivate[];
...
extern const u8 gText_EmbodyAspectActivate[];
