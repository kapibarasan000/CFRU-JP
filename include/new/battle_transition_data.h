...
#define TwoBars_MugshotTiles ((const u16*) 0x83BFACC)
#define TwoBars_MugshotPal ((const u16*) 0x83C11CC)
#define TwoBars_MugshotMap ((const u16*) 0x83C17A0)

#define sOpponentMugshotsPals ((const u16**) 0x83C12AC)
#define sPlayerMugshotsPals ((const u16**) 0x83C12C0)
#define sMugshotsTrainerPicIDsTable ((const u8*) 0x3C1000)
