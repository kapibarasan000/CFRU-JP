...
void __attribute__((long_call)) sub_80118E8(struct Sprite *sprite);
...
void __attribute__((long_call)) sub_8011894(struct Sprite *sprite);
...
void __attribute__((long_call)) sub_8016C44(u8 bank);
void __attribute__((long_call)) sub_8016CC8(bank_t);
...
void __attribute__((long_call)) sub_802EEB0(void);
void __attribute__((long_call)) sub_802EEE8(void);
...
void __attribute__((long_call)) sub_803323C(void);
void __attribute__((long_call)) sub_8033660(struct Sprite *sprite);
...
void __attribute__((long_call)) sub_803535C(void);
...
u8 __attribute__((long_call)) sub_8043E08(void); //Something Trainer Related
...
void __attribute__((long_call)) sub_8072AC0(u8 taskId);
...
void __attribute__((long_call)) sub_80745B8(struct Sprite *sprite);
...
//u8* __attribute__((long_call)) TryGetStatusString(u8 *src); //日本語版には存在しない
...
bool8 __attribute__((long_call)) sub_80EC28C(u32 a);
