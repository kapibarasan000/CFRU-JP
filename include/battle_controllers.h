...
void __attribute__((long_call)) sub_805806C(void);
void __attribute__((long_call)) sub_805C4BC(struct Sprite *sprite);
...
void __attribute__((long_call)) c3_0802F574(u8 taskId);
