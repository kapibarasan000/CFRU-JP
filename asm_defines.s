...
@Custom Defines
.equ MAX_LEVEL, 100
.equ fossilImageTable, 0x086D0000
.equ pcSelect_StateTracker, 0x0203B724
.equ gCreateSpriteTableSetter, 0x0203B725
.equ EV_CAP, 252


@Custom Ram Locs
.equ BATTLE_STRING_LOADER, 0x203DF98
.equ SEED_HELPER, 0x203DF9C
.equ TERRAIN_BYTE, 0x203DFA0
.equ FORM_COUNTER, 0x203DFA1
.equ POISONED_BY, 0x203DFA2
	@ 0x1 = Poison Touch	/ 0x1 = Beak Blast Burn
	@ 0x2 = Toxic Spikes
	@ 0x3 = Toxic Orb		/ 0x3 = Flame Orb
	@ 0x4 = Baneful Bunker
.equ MAGICIAN_HELPER, 0x203DFA3
.equ SHAKER_HELPER, 0x203DFA4
.equ FORCE_SWITCH_HELPER, 0x203DFA6
.equ BACKUP_HWORD, 0x203DFA9
.equ MULTICHOICE_STRING_LOADER, 0x203E000 @LEAVE AS IS! USED BY SPECIAL INSERTS!
.equ MULTICHOICE_WIDTH, 0x13
...
.equ EFFECT_BANK, 0x2023CCE
.equ SWITCHING_BANK, 0x203DFAC
.equ ANIM_TARGET, 0x2037E4F
.equ BATTLE_SCRIPTING_BANK, 0x2023F3B
.equ FAINTED_BANK, gBankFainted
.equ SPECIAL_STATUS_BITS, 0x2023D5C
.equ DISABLE_STRUCT, 0x2023D6C
.equ PROTECT_STRUCT, 0x2023DEC
.equ PARTY_TIMERS, 0x2023D44
.equ SIDE_STATUSES, 0x2023D3E
.equ PARTY_PLAYER, 0x20241E4
.equ PARTY_OPPONENT, 0x2023F8C
.equ BANK_PARTY_NUMBERS, 0x2023B2E
.equ ANIM_ARG_1, 0x2023F34
.equ STAT_CHANGE_BYTE, 0x2023F3E
.equ STAT_ANIM_PLAYED, 0x2023F3F
.equ MULTISTRING_CHOOSER, 0x2023DE7
.equ DAMAGE_LOC, 0x2023CB0
.equ HP_DEALT, 0x2023CB4
.equ DAMAGE_STRUCT, 0x2023E2C
.equ MULTI_HIT_COUNTER, 0x2023CD2
.equ TRIPLE_KICK_POWER, 0x2023F36

.equ ACTIVE_BATTLER, 0x2023B24
.equ NUM_POKEMON, 0x2023B2C
.equ TURN_ORDER, 0x2023B3E
.equ BS_SCRIPT_LOC, 0x2023CD4
.equ DP08_POINTER, 0x2023F48
.equ HIT_MARKER, 0x2023D30
.equ OUTCOME, 0x2023D2C
.equ WEATHER_FLAGS, 0x2023E7C
.equ WEATHER_TIMER, 0x2023EA8
.equ BATTLE_TYPE, 0x2022AAC
.equ ITEM_BUFFER, 0x2023CC8
.equ MOVES_TO_BE_USED, 0x2023D24
.equ EFFECT_BYTE, 0x2023DE5
.equ BATTLE_OUTCOME, 0x2023DEA
.equ NO_COMMON_BITS, 0x2023D30
.equ BATTLE_COMMUNICATION, 0x2023DE2
.equ ABSENT_BATTLER_FLAGS, 0x2023CD0
.equ BATTLE_RESOURCES, 0x2023F78
.equ PAIN_SPLIT_HP, 0x2023F24
.equ DMG_MULTIPLIER, 0x2023F32
.equ TWOTURN_STRINGID, 0x2023F33
.equ MULTIHIT_MOVE_EFFECT, 0x2023F3A
.equ ANIM_TURN, 0x2023F3C
.equ ANIM_TARGETS_HIT, 0x2023F3D
.equ MULTIHIT_STRING, 0x2023F2C
.equ CMD49_STATE, 0x2023F38
.equ EXP_STATE, 0x2023F40
.equ BATTLE_ANIM_ARGS, 0x2037E36
.equ BATTLE_STYLE, gBattleScripting + 0x1D

@Save Data Pointers
@.equ MapDMA, 0x03005048
@.equ TrainerDMA, 0x0300504C
.equ BoxDMA, 0x03005050

@Scripting
.equ var8000, 0x02036FEC
.equ var8001, 0x02036FEE
.equ var8002, 0x02036FF0
.equ var8003, 0x02036FF2
.equ var8004, 0x02036FF4
.equ var8005, 0x02036FF6
.equ var8006, 0x02036FF8
.equ var8007, 0x02036FFA
.equ var8008, 0x02036FFC
.equ var8009, 0x02036FFE
.equ var800a, 0x02037000
.equ var800b, 0x02037002
.equ var800d, 0x02037004
.equ var800f, 0x02037006
.equ var800c, 0x02037008
.equ var800e, 0x0203ACA8
.equ var8010, 0x0203700A
.equ var8011, 0x0203700C
...
.equ MOVE_EFFECT_SYRUP_BOMB,          0x26
...
.equ ANIM_TERASTAL, 0x4E
.equ ANIM_SUBSTITUTE2, 0x4F
.equ ANIM_SALTCURE_END_TURN, 0x50
.equ ANIM_SYRUPBOMB_END_TURN, 0x51
.equ ANIM_AI_ITEM_HEAL, 0x52
...
.equ ABILITY_ASONE_CHILLING, 266
.equ ABILITY_ASONE_GRIM, 267
...
.equ ABILITY_EMBODYASPECT_TEALMASK, 301
.equ ABILITY_EMBODYASPECT_HEARTHFLAMEMASK, 302
.equ ABILITY_EMBODYASPECT_WELLSPRINGMASK, 303
.equ ABILITY_EMBODYASPECT_CORNERSTONEMASK, 304
...
.equ MOVE_MAX_GUARD, 0x334
.equ MOVE_MAX_STRIKE_P, 0x335
.equ MOVE_MAX_STRIKE_S, 0x336
.equ MOVE_MAX_KNUCKLE_P, 0x337
.equ MOVE_MAX_KNUCKLE_S, 0x338
.equ MOVE_MAX_AIRSTREAM_P, 0x339
.equ MOVE_MAX_AIRSTREAM_S, 0x33A
.equ MOVE_MAX_OOZE_P, 0x33B
.equ MOVE_MAX_OOZE_S, 0x33C
.equ MOVE_MAX_QUAKE_P, 0x33D
.equ MOVE_MAX_QUAKE_S, 0x33E
.equ MOVE_MAX_ROCKFALL_P, 0x33F
.equ MOVE_MAX_ROCKFALL_S, 0x340
.equ MOVE_MAX_FLUTTERBY_P, 0x341
.equ MOVE_MAX_FLUTTERBY_S, 0x342
.equ MOVE_MAX_PHANTASM_P, 0x343
.equ MOVE_MAX_PHANTASM_S, 0x344
.equ MOVE_MAX_STEELSPIKE_P, 0x345
.equ MOVE_MAX_STEELSPIKE_S, 0x346
.equ MOVE_MAX_FLARE_P, 0x347
.equ MOVE_MAX_FLARE_S, 0x348
.equ MOVE_MAX_GEYSER_P, 0x349
.equ MOVE_MAX_GEYSER_S, 0x34A
.equ MOVE_MAX_OVERGROWTH_P, 0x34B
.equ MOVE_MAX_OVERGROWTH_S, 0x34C
.equ MOVE_MAX_LIGHTNING_P, 0x34D
.equ MOVE_MAX_LIGHTNING_S, 0x34E
.equ MOVE_MAX_MINDSTORM_P, 0x34F
.equ MOVE_MAX_MINDSTORM_S, 0x350
.equ MOVE_MAX_HAILSTORM_P, 0x351
.equ MOVE_MAX_HAILSTORM_S, 0x352
.equ MOVE_MAX_WYRMWIND_P, 0x353
.equ MOVE_MAX_WYRMWIND_S, 0x354
.equ MOVE_MAX_DARKNESS_P, 0x355
.equ MOVE_MAX_DARKNESS_S, 0x356
.equ MOVE_MAX_STARFALL_P, 0x357
.equ MOVE_MAX_STARFALL_S, 0x358
.equ MOVE_G_MAX_VINE_LASH_P, 0x359
.equ MOVE_G_MAX_VINE_LASH_S, 0x35A
.equ MOVE_G_MAX_WILDFIRE_P, 0x35B
.equ MOVE_G_MAX_WILDFIRE_S, 0x35C
.equ MOVE_G_MAX_CANNONADE_P, 0x35D
.equ MOVE_G_MAX_CANNONADE_S, 0x35E
.equ MOVE_G_MAX_BEFUDDLE_P, 0x35F
.equ MOVE_G_MAX_BEFUDDLE_S, 0x360
.equ MOVE_G_MAX_VOLT_CRASH_P, 0x361
.equ MOVE_G_MAX_VOLT_CRASH_S, 0x362
.equ MOVE_G_MAX_GOLD_RUSH_P, 0x363
.equ MOVE_G_MAX_GOLD_RUSH_S, 0x364
.equ MOVE_G_MAX_CHI_STRIKE_P, 0x365
.equ MOVE_G_MAX_CHI_STRIKE_S, 0x366
.equ MOVE_G_MAX_TERROR_P, 0x367
.equ MOVE_G_MAX_TERROR_S, 0x368
.equ MOVE_G_MAX_FOAM_BURST_P, 0x369
.equ MOVE_G_MAX_FOAM_BURST_S, 0x36A
.equ MOVE_G_MAX_RESONANCE_P, 0x36B
.equ MOVE_G_MAX_RESONANCE_S, 0x36C
.equ MOVE_G_MAX_CUDDLE_P, 0x36D
.equ MOVE_G_MAX_CUDDLE_S, 0x36E
.equ MOVE_G_MAX_REPLENISH_P, 0x36F
.equ MOVE_G_MAX_REPLENISH_S, 0x370
.equ MOVE_G_MAX_MALODOR_P, 0x371
.equ MOVE_G_MAX_MALODOR_S, 0x372
.equ MOVE_G_MAX_MELTDOWN_P, 0x373
.equ MOVE_G_MAX_MELTDOWN_S, 0x374
.equ MOVE_G_MAX_DRUM_SOLO_P, 0x375
.equ MOVE_G_MAX_DRUM_SOLO_S, 0x376
.equ MOVE_G_MAX_FIREBALL_P, 0x377
.equ MOVE_G_MAX_FIREBALL_S, 0x378
.equ MOVE_G_MAX_HYDROSNIPE_P, 0x379
.equ MOVE_G_MAX_HYDROSNIPE_S, 0x37A
.equ MOVE_G_MAX_WIND_RAGE_P, 0x37B
.equ MOVE_G_MAX_WIND_RAGE_S, 0x37C
.equ MOVE_G_MAX_GRAVITAS_P, 0x37D
.equ MOVE_G_MAX_GRAVITAS_S, 0x37E
.equ MOVE_G_MAX_STONESURGE_P, 0x37F
.equ MOVE_G_MAX_STONESURGE_S, 0x380
.equ MOVE_G_MAX_VOLCALITH_P, 0x381
.equ MOVE_G_MAX_VOLCALITH_S, 0x382
.equ MOVE_G_MAX_TARTNESS_P, 0x383
.equ MOVE_G_MAX_TARTNESS_S, 0x384
.equ MOVE_G_MAX_SWEETNESS_P, 0x385
.equ MOVE_G_MAX_SWEETNESS_S, 0x386
.equ MOVE_G_MAX_SANDBLAST_P, 0x387
.equ MOVE_G_MAX_SANDBLAST_S, 0x388
.equ MOVE_G_MAX_STUN_SHOCK_P, 0x389
.equ MOVE_G_MAX_STUN_SHOCK_S, 0x38A
.equ MOVE_G_MAX_CENTIFERNO_P, 0x38B
.equ MOVE_G_MAX_CENTIFERNO_S, 0x38C
.equ MOVE_G_MAX_SMITE_P, 0x38D
.equ MOVE_G_MAX_SMITE_S, 0x38E
.equ MOVE_G_MAX_SNOOZE_P, 0x38F
.equ MOVE_G_MAX_SNOOZE_S, 0x390
.equ MOVE_G_MAX_FINALE_P, 0x391
.equ MOVE_G_MAX_FINALE_S, 0x392
.equ MOVE_G_MAX_STEELSURGE_P, 0x393
.equ MOVE_G_MAX_STEELSURGE_S, 0x394
.equ MOVE_G_MAX_DEPLETION_P, 0x395
.equ MOVE_G_MAX_DEPLETION_S, 0x396
.equ MOVE_G_MAX_ONE_BLOW_P, 0x397
.equ MOVE_G_MAX_ONE_BLOW_S, 0x398
.equ MOVE_G_MAX_RAPID_FLOW_P, 0x399
.equ MOVE_G_MAX_RAPID_FLOW_S, 0x39A
...
.equ STATUS3_SEMI_INVULNERABLE, STATUS3_INAIR | STATUS3_UNDERGROUND | STATUS3_UNDERWATER | STATUS3_DISAPPEARED | STATUS3_COMMANDER
...
.equ ITEM_EFFECT_ABILITY_SHIELD, 147
...
.equ SPECIES_TATSUGIRI_DROOPY, 0x55D
.equ SPECIES_TATSUGIRI_STRETCHY, 0x55E
...
.equ ITEM_TM49, 0x151
.equ ITEM_TM50, 0x152
.equ ITEM_HM01_CUT, 0x153
.equ ITEM_HM02_FLY, 0x154
.equ ITEM_HM03_SURF, 0x155
.equ ITEM_HM04_STRENGTH, 0x156
.equ ITEM_HM05_DIVE, 0x157
.equ ITEM_HM06_ROCK_SMASH, 0x158
.equ ITEM_HM07_WATERFALL, 0x159
.equ ITEM_HM08_ROCK_CLIMB, 0x15A
...
.equ ITEM_TM98, 0x1A7 
.equ ITEM_TM99, 0x1A8 
.equ ITEM_TM100, 0x1A9 
.equ ITEM_TM101, 0x1AA 
.equ ITEM_TM102, 0x1AB 
.equ ITEM_TM103, 0x1AC 
.equ ITEM_TM104, 0x1AD 
.equ ITEM_TM105, 0x1AE 
.equ ITEM_TM106, 0x1AF 
.equ ITEM_TM107, 0x1B0 
.equ ITEM_TM108, 0x1B1 
.equ ITEM_TM109, 0x1B2 
.equ ITEM_TM110, 0x1B3 
.equ ITEM_TM111, 0x1B4 
.equ ITEM_TM112, 0x1B5 
.equ ITEM_TM113, 0x1B6 
.equ ITEM_TM114, 0x1B7 
.equ ITEM_TM115, 0x1B8 
.equ ITEM_TM116, 0x1B9 
.equ ITEM_TM117, 0x1BA 
.equ ITEM_TM118, 0x1BB 
.equ ITEM_TM119, 0x1BC 
.equ ITEM_TM120, 0x1BD 
...
.equ ITEM_X_SP_DEF, 375 @DONT USE THIS. This is to help CFRU compile
...
.equ ITEM_AUSPICIOUS_ARMOR, 0x2DA
.equ ITEM_MALICIOUS_ARMOR, 0x2DB
.equ ITEM_BLACK_AUGURITE, 0x2DC
.equ ITEM_METAL_ALLOY, 0x2DD
.equ ITEM_PEAT_BLOCK, 0x2DE
.equ ITEM_LEADERS_CREST, 0x2DF
.equ ITEM_GIMMIGHOUL_COIN, 0x2E0
.equ ITEM_SYRUPY_APPLE, 0x2E1
.equ ITEM_CLEAR_AMULET, 0x2E2
.equ ITEM_COVERT_CLOAK, 0x2E3
.equ ITEM_LOADED_DICE, 0x2E4
.equ ITEM_PUNCHING_GLOVE, 0x2E5
.equ ITEM_REINS_OF_UNITY, 0x2E6
.equ ITEM_BOOSTER_ENERGY, 0x2E7
.equ ITEM_WELLSPRING_MASK, 0x2E8
.equ ITEM_HEARTHFLAME_MASK, 0x2E9
.equ ITEM_CORNERSTONE_MASK, 0x2EA
.equ ITEM_TEAL_MASK, 0x2EB
.equ ITEM_MASTERPIECE_TEACUP, 0x2EC
.equ ITEM_UNREMARKABLE_TEACUP, 0x2ED
.equ ITEM_TERA_ORB, 0x2EE
.equ ITEM_MIRROR_HERB, 0x2EF
.equ ITEM_ABILITY_SHIELD, 0x2F0
.equ ITEM_LONELY_MINT, 0x2F1
.equ ITEM_ADAMANT_MINT, 0x2F2
.equ ITEM_NAUGHTY_MINT, 0x2F3
.equ ITEM_BRAVE_MINT, 0x2F4
.equ ITEM_BOLD_MINT, 0x2F5
.equ ITEM_IMPISH_MINT, 0x2F6
.equ ITEM_LAX_MINT, 0x2F7
.equ ITEM_RELAXED_MINT, 0x2F8
.equ ITEM_MODEST_MINT, 0x2F9
.equ ITEM_MILD_MINT, 0x2FA
.equ ITEM_RASH_MINT, 0x2FB
.equ ITEM_QUIET_MINT, 0x2FC
.equ ITEM_CALM_MINT, 0x2FD
.equ ITEM_GENTLE_MINT, 0x2FE
.equ ITEM_CAREFUL_MINT, 0x2FF
.equ ITEM_SASSY_MINT, 0x300
.equ ITEM_TIMID_MINT, 0x301
.equ ITEM_HASTY_MINT, 0x302
.equ ITEM_JOLLY_MINT, 0x303
.equ ITEM_NAIVE_MINT, 0x304
.equ ITEM_SERIOUS_MINT, 0x305
...
.equ EFFECT_LAST_RESORT, 242
.equ EFFECT_DAMAGE_SET_TERRAIN, 243
.equ EFFECT_TEATIME, 244
.equ EFFECT_POLTERGEIST, 245
.equ EFFECT_SKY_DROP, 246
.equ EFFECT_GLAIVE_RUSH, 247
.equ EFFECT_TERA_BLAST, 248
