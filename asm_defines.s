...
.equ MOVE_STOKED_SPARKSURFER, 0x30D
.equ MOVE_EXTREME_EVOBOOST, 0x30E
.equ MOVE_PULVERIZING_PANCAKE, 0x30F
.equ MOVE_GENESIS_SUPERNOVA, 0x310
.equ MOVE_SINISTER_ARROW_RAID, 0x311
.equ MOVE_MALICIOUS_MOONSAULT, 0x312
.equ MOVE_OCEANIC_OPERETTA, 0x313
.equ MOVE_SPLINTERED_STORMSHARDS, 0x314
.equ MOVE_LETS_SNUGGLE_FOREVER, 0x315
.equ MOVE_CLANGOROUS_SOULBLAZE, 0x316
...
.equ MOVE_MAX_GUARD, 0x31C
.equ MOVE_MAX_STRIKE_P, 0x31D
.equ MOVE_MAX_STRIKE_S, 0x31E
.equ MOVE_MAX_KNUCKLE_P, 0x31F
.equ MOVE_MAX_KNUCKLE_S, 0x320
.equ MOVE_MAX_AIRSTREAM_P, 0x321
.equ MOVE_MAX_AIRSTREAM_S, 0x322
.equ MOVE_MAX_OOZE_P, 0x323
.equ MOVE_MAX_OOZE_S, 0x324
.equ MOVE_MAX_QUAKE_P, 0x325
.equ MOVE_MAX_QUAKE_S, 0x326
.equ MOVE_MAX_ROCKFALL_P, 0x327
.equ MOVE_MAX_ROCKFALL_S, 0x328
.equ MOVE_MAX_FLUTTERBY_P, 0x329
.equ MOVE_MAX_FLUTTERBY_S, 0x32A
.equ MOVE_MAX_PHANTASM_P, 0x32B
.equ MOVE_MAX_PHANTASM_S, 0x32C
.equ MOVE_MAX_STEELSPIKE_P, 0x32D
.equ MOVE_MAX_STEELSPIKE_S, 0x32E
.equ MOVE_MAX_FLARE_P, 0x32F
.equ MOVE_MAX_FLARE_S, 0x330
.equ MOVE_MAX_GEYSER_P, 0x331
.equ MOVE_MAX_GEYSER_S, 0x332
.equ MOVE_MAX_OVERGROWTH_P, 0x333
.equ MOVE_MAX_OVERGROWTH_S, 0x334
.equ MOVE_MAX_LIGHTNING_P, 0x335
.equ MOVE_MAX_LIGHTNING_S, 0x336
.equ MOVE_MAX_MINDSTORM_P, 0x337
.equ MOVE_MAX_MINDSTORM_S, 0x338
.equ MOVE_MAX_HAILSTORM_P, 0x339
.equ MOVE_MAX_HAILSTORM_S, 0x33A
.equ MOVE_MAX_WYRMWIND_P, 0x33B
.equ MOVE_MAX_WYRMWIND_S, 0x33C
.equ MOVE_MAX_DARKNESS_P, 0x33D
.equ MOVE_MAX_DARKNESS_S, 0x33E
.equ MOVE_MAX_STARFALL_P, 0x33F
.equ MOVE_MAX_STARFALL_S, 0x340
.equ MOVE_G_MAX_VINE_LASH_P, 0x341
.equ MOVE_G_MAX_VINE_LASH_S, 0x342
.equ MOVE_G_MAX_WILDFIRE_P, 0x343
.equ MOVE_G_MAX_WILDFIRE_S, 0x344
.equ MOVE_G_MAX_CANNONADE_P, 0x345
.equ MOVE_G_MAX_CANNONADE_S, 0x346
.equ MOVE_G_MAX_BEFUDDLE_P, 0x347
.equ MOVE_G_MAX_BEFUDDLE_S, 0x348
.equ MOVE_G_MAX_VOLT_CRASH_P, 0x349
.equ MOVE_G_MAX_VOLT_CRASH_S, 0x34A
.equ MOVE_G_MAX_GOLD_RUSH_P, 0x34B
.equ MOVE_G_MAX_GOLD_RUSH_S, 0x34C
.equ MOVE_G_MAX_CHI_STRIKE_P, 0x34D
.equ MOVE_G_MAX_CHI_STRIKE_S, 0x34E
.equ MOVE_G_MAX_TERROR_P, 0x34F
.equ MOVE_G_MAX_TERROR_S, 0x350
.equ MOVE_G_MAX_FOAM_BURST_P, 0x351
.equ MOVE_G_MAX_FOAM_BURST_S, 0x352
.equ MOVE_G_MAX_RESONANCE_P, 0x353
.equ MOVE_G_MAX_RESONANCE_S, 0x354
.equ MOVE_G_MAX_CUDDLE_P, 0x355
.equ MOVE_G_MAX_CUDDLE_S, 0x356
.equ MOVE_G_MAX_REPLENISH_P, 0x357
.equ MOVE_G_MAX_REPLENISH_S, 0x358
.equ MOVE_G_MAX_MALODOR_P, 0x359
.equ MOVE_G_MAX_MALODOR_S, 0x35A
.equ MOVE_G_MAX_MELTDOWN_P, 0x35B
.equ MOVE_G_MAX_MELTDOWN_S, 0x35C
.equ MOVE_G_MAX_DRUM_SOLO_P, 0x35D
.equ MOVE_G_MAX_DRUM_SOLO_S, 0x35E
.equ MOVE_G_MAX_FIREBALL_P, 0x35F
.equ MOVE_G_MAX_FIREBALL_S, 0x360
.equ MOVE_G_MAX_HYDROSNIPE_P, 0x361
.equ MOVE_G_MAX_HYDROSNIPE_S, 0x362
.equ MOVE_G_MAX_WIND_RAGE_P, 0x363
.equ MOVE_G_MAX_WIND_RAGE_S, 0x364
.equ MOVE_G_MAX_GRAVITAS_P, 0x365
.equ MOVE_G_MAX_GRAVITAS_S, 0x366
.equ MOVE_G_MAX_STONESURGE_P, 0x367
.equ MOVE_G_MAX_STONESURGE_S, 0x368
.equ MOVE_G_MAX_VOLCALITH_P, 0x369
.equ MOVE_G_MAX_VOLCALITH_S, 0x36A
.equ MOVE_G_MAX_TARTNESS_P, 0x36B
.equ MOVE_G_MAX_TARTNESS_S, 0x36C
.equ MOVE_G_MAX_SWEETNESS_P, 0x36D
.equ MOVE_G_MAX_SWEETNESS_S, 0x36E
.equ MOVE_G_MAX_SANDBLAST_P, 0x36F
.equ MOVE_G_MAX_SANDBLAST_S, 0x370
.equ MOVE_G_MAX_STUN_SHOCK_P, 0x371
.equ MOVE_G_MAX_STUN_SHOCK_S, 0x372
.equ MOVE_G_MAX_CENTIFERNO_P, 0x373
.equ MOVE_G_MAX_CENTIFERNO_S, 0x374
.equ MOVE_G_MAX_SMITE_P, 0x375
.equ MOVE_G_MAX_SMITE_S, 0x376
.equ MOVE_G_MAX_SNOOZE_P, 0x377
.equ MOVE_G_MAX_SNOOZE_S, 0x378
.equ MOVE_G_MAX_FINALE_P, 0x379
.equ MOVE_G_MAX_FINALE_S, 0x37A
.equ MOVE_G_MAX_STEELSURGE_P, 0x37B
.equ MOVE_G_MAX_STEELSURGE_S, 0x37C
.equ MOVE_G_MAX_DEPLETION_P, 0x37D
.equ MOVE_G_MAX_DEPLETION_S, 0x37E
.equ MOVE_G_MAX_ONE_BLOW_P, 0x37F
.equ MOVE_G_MAX_ONE_BLOW_S, 0x380
.equ MOVE_G_MAX_RAPID_FLOW_P, 0x381
.equ MOVE_G_MAX_RAPID_FLOW_S, 0x382
