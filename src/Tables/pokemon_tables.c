...
const struct AlternateSize gAlternateSpeciesSizeTable[] =
{
	...
	ALTERNATE_SIZE(SPECIES_PIDGEOT_MEGA, 2.2, 50.5),
	...
	ALTERNATE_SIZE(SPECIES_ALAKAZAM_MEGA, 1.2, 48.0),
	...
	ALTERNATE_SIZE(SPECIES_MAUSHOLD_FOUR, 0.3, 2.8),
	ALTERNATE_SIZE(SPECIES_PALAFIN_HERO, 1.8, 97.4),
	ALTERNATE_SIZE(SPECIES_DUDUNSPARCE_THREE, 4.5, 47.4),
	ALTERNATE_SIZE(SPECIES_GIMMIGHOUL_ROAMING, 0.1, 0.1),
	ALTERNATE_SIZE(SPECIES_WOOPER_P, 0.4, 11.0),
	ALTERNATE_SIZE(SPECIES_TAUROS_P, 1.4, 115.0),
	ALTERNATE_SIZE(SPECIES_TAUROS_BLAZE_P, 1.4, 85.0),
	ALTERNATE_SIZE(SPECIES_TAUROS_AQUA_P, 1.4, 110.0),
	ALTERNATE_SIZE(SPECIES_URSALUNA_BLOODMOON, 2.7, 333.0),
	ALTERNATE_SIZE(SPECIES_TERAPAGOS_TERASTAL, 0.3, 16.0),
	ALTERNATE_SIZE(SPECIES_TERAPAGOS_STELLAR, 1.7, 77.0),
