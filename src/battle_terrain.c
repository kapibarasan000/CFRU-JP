...
#define gBattleTerrainTable ((struct BattleBackground*) *((u32*) 0x800ECD4))
#ifdef UNBOUND
...
void DrawBattleEntryBackground(void)
{
	...
	{
		LZDecompressVram((void*) 0x8D7732C, (void*) (BG_CHAR_ADDR(1)));
		LZDecompressVram((void*) 0x08D77548, (void*) (VRAM + 0x10000));
		LoadCompressedPalette((void*) 0x8D77520, 0x60, 0x20);
		SetBgAttribute(1, BG_ATTR_SCREENSIZE, 1);
        SetGpuReg(REG_OFFSET_BG1CNT, BGCNT_PRIORITY(0) | BGCNT_CHARBASE(1) | BGCNT_16COLOR | BGCNT_SCREENBASE(28) | BGCNT_TXT512x256);
        CopyToBgTilemapBuffer(1, (void*) 0x8D77414, 0, 0);
		CopyToBgTilemapBuffer(2, (void*) 0x8D77414, 0, 0);
        ...
        gBattle_BG1_Y = -164;
        gBattle_BG2_Y = -164;
		LoadCompressedSpriteSheetUsingHeap((void*) 0x82051F4);
	}
	else
	{
