...
#define LoadNPCPalette(PalTag, PalSlot) ((void(*)(u16, u8))0x805EDF8+1)(PalTag, PalSlot)
#define TintOBJPalette(PalSlot) ((void(*)(u8))0x8083184+1)(PalSlot)

#define OverworldIsActive FuncIsActiveTask(Task_WeatherMain)

#define SetUpDisguise(Arg1, Arg2, PalSlot) ((u8(*)(u8, u8, u8))0x80DD9F8+1)(Arg1, Arg2, PalSlot)
...
#define sPalRefs ((struct PalRef*) 0x203B74C) //Make sure to change reference in BT scripts if modified
...
u8 GetPalSlotMisc(u32 OBJData)
{
	...
	DoLoadSpritePalette((u16*) 0x8389A64, palSlot * 16);
...
#define gSandstormWeatherPalette (const u16*) 0x8389AA4
