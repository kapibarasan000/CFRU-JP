...
#define BattleScript_LevelUp (u8*) 0x81BC9B1
...
static void sub_802F874(u8 taskId);
...
void PlayerHandleExpBarUpdate(void)
{
	...
	else
	{
		...
		gBattlerControllerFuncs[gActiveBattler] = (void*) (0x802DAEC | 1);
	}
}
...
static void Task_GiveExpToMon(u8 taskId)
{
	...
	else //Single Battle
	{
		...
		gTasks[taskId].func = sub_802F874;
	}
}
