...
#define sRaidBattleIntroPtr (*((struct RaidBattleIntro**) 0x203DFB0))
...
static void PrintInstructions(void)
{
	...
	WindowPrint(WIN_RULES, 0, 0, 0, &colour, 0, gText_RaidBattleRules);
	...
	WindowPrint(WIN_INSTRUCTIONS, 0, 0, 4, &colour, 0, gText_RaidIntroSelection);
...
#define TransferPlttBuffer ((TransferPlttBuffer_T) (0x0806FC18 |1))
