...
{
	[MB_BOOKSHELF] = (void*) 0x8194BB0,
	[MB_POKEMART_SHELF] = (void*) 0x8194BB9,
	[MB_PC] = (void*) 0x8194221,
	[MB_REGION_MAP] = (void*) 0x81944FE,
	[MB_CABINET] = (void*) 0x8194C01,
	[MB_KITCHEN] = (void*) 0x8194C0A,
	[MB_DRESSER] = (void*) 0x8194C13,
	[MB_SNACKS] = (void*) 0x8194C1C,
	[MB_QUESTIONNAIRE] = (void*) 0x8194CAC,
	[MB_FOOD] = (void*) 0x8194BC2,
	[MB_BLUEPRINTS] = (void*) 0x8194BE6,
	[MB_PAINTING] = (void*) 0x8194C25,
	[MB_POWER_PLANT_MACHINE] = (void*) 0x8194C2E,
	[MB_TELEPHONE] = (void*) 0x8194C37,
	[MB_COMPUTER] = (void*) 0x8194BD4,
	[MB_ADVERTISING_POSTER] = (void*) 0x8194C40,
	[MB_FOOD_SMELLS_TASTY] = (void*) 0x8194C49,
	[MB_TRASH_BIN] = (void*) 0x8194C52,
	[MB_CUP] = (void*) 0x8194C5B,
	[MB_BLINKING_LIGHTS] = (void*) 0x8194C76,
	[MB_TOOLS] = (void*) 0x8194C7F,
	[MB_IMPRESSIVE_MACHINE] = (void*) 0x8194BDD,
	[MB_VIDEO_GAME] = (void*) 0x8194BCB,
	[MB_BURGLARY] = (void*) 0x8194BEF,
	[MB_TRAINER_TOWER_RECORD] = (void*) 0x81A9C24,

	[MB_TELEVISION] = (void*) 0x8194BF8,
	[MB_BERRY_CRUSH_RECORDS] = (void*) 0x81A34BE,
	[MB_BATTLE_RECORDS] = (void*) 0x81A2D8D,

	[MB_POKEMON_CENTER_SIGN] = (void*) 0x8194C91,
	[MB_POKEMART_SIGN] = (void*) 0x8194C88,
	[MB_INDIGO_PLATEAU_MARK_DPAD] = (void*) 0x8194C9A,
	[MB_INDIGO_PLATEAU_MARK_2_DPAD] = (void*) 0x8194CA3,
...
{
	#define Tileset_0 (struct Tileset*) 0x8298B44
	#define Tileset_7 (struct Tileset*) 0x8298BEC
	#define Tileset_8 (struct Tileset*) 0x8298C04
	#define Tileset_34 (struct Tileset*) 0x8298E74
...
{
	#define Tileset_General (struct Tileset*) 0x8298B44
	#define Tileset_CraterTown (struct Tileset*) 0x8298B8C
	#define Tileset_DrescoTown (struct Tileset*) 0x8298BA4
	#define Tileset_FallshoreCity (struct Tileset*) 0x8744D8C
	#define Tileset_DeharaCity (struct Tileset*) 0x8298BEC
	#define Tileset_GurunTown (struct Tileset*) 0x8298BD4
	#define Tileset_Route17 (struct Tileset*) 0x8298C4C
	#define Tileset_FlowerParadise (struct Tileset*) 0x8B56314
	#define Tileset_Forest (struct Tileset*) 0x82990B4
...
static void Task_OverworldMultiTrainers(u8 id)
{
	...
	switch (task->data[0]) {
		...
		case 5:
			...
			ScriptContext1_SetupScript((u8*) 0x08192F0E);
...
#define sText_ScurriedHome (const u8*) 0x83E1403
