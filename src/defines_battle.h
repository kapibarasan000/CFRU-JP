...
#define IS_MOLD_BREAKER(ability, move) (IsMoldBreakerAbility(ability) || CheckTableForMove(move, gMoldBreakerMoves))
#define NO_MOLD_BREAKERS(ability, move) (!IsMoldBreakerAbility(ability) && !CheckTableForMove(move, gMoldBreakerMoves))
...
#define BattleScript_Atk49 (u8*) 0x81BA910
extern u8 BattleScript_ButItFailed[];
#define BattleScript_NotAffected (const u8*) 0x81BBDC0

typedef u8 TrainerClassNames_t[11];
#define gTrainerClassNames ((TrainerClassNames_t*) *((u32*) 0x811BCF0)) //0x823E558
#define gTrainers ((struct Trainer*) *((u32*) 0x800F5C0)) //0x823EAC8
#define gTrainerFrontPicCoords ((struct TrainerPicCoords*) 0x81F8910)
#define gTrainerFrontPicTable ((struct CompressedSpriteSheet*) 0x81F8B60)
#define gTrainerFrontPicPaletteTable ((struct CompressedSpritePalette*) 0x81F9000)
extern struct TrainerPicCoords gTrainerBackPicCoords[];

#define sATypeMove_Table ((u8**) 0x80D86D0) //Table of things like "A Normal Move!"
#define gBattleStringsTable ((u8**) 0x83C3F08)

#define gStatusConditionString_Poison ((u8*) 0x83C47B4)
#define gStatusConditionString_Sleep ((u8*) 0x83C47B0)
#define gStatusConditionString_Paralysis ((u8*) 0x83C47BB)
#define gStatusConditionString_Burn ((u8*) 0x83C47B7)
#define gStatusConditionString_Ice ((u8*) 0x83C47BE)
#define gStatusConditionString_Confusion ((u8*) 0x83C47C2)
#define gStatusConditionString_Love ((u8*) 0x83C47C7)
