...
#define BattleScript_ItemHealHP_Ret (u8*) 0x81BD5DE
#define BattleScript_ItemHealHP_End2 (u8*) 0x81BD5D8
#define BattleScript_WhiteHerbRet (u8*) 0x81BD59B
#define BattleScript_WhiteHerbEnd2 (u8*) 0x81BD595
...
u8 ItemBattleEffects(u8 caseID, u8 bank, bool8 moveTurn, bool8 doPluck)
{
	...
	u16 atkItem;
	u8 moveSplit = CalcMoveSplit(gBankAttacker, gCurrentMove, bank);
