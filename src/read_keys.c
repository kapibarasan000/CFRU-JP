...
static void CB2_PartyMenuFromField(void)
{
    InitPartyMenu(PARTY_MENU_TYPE_FIELD, PARTY_LAYOUT_SINGLE, PARTY_ACTION_CHOOSE_MON, FALSE, PARTY_MSG_CHOOSE_MON, (void*) (0x8120318 | 1), CB2_ReturnToFieldContinueScript);
}
