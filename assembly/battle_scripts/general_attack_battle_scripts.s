...
BattleScript_AbsorbLiquidOoze:
	...
	printfromtable 0x83C45A8 @;gLeechSeedDrainStringIds
	waitmessage DELAY_1SECOND
	call BattleScript_AbilityPopUpRevert
...
BS_008_DreamEater:
	...
	ppreduce
	waitmessage DELAY_1SECOND
	goto 0x81BA97A @;Target wasn't affected
...
TarShotBS:
	jumpifcounter BANK_TARGET TAR_SHOT_TIMERS NOTEQUALS 0 0x81BABCF @;Already set
	attackcanceler
	jumpifbehindsubstitute BANK_TARGET FAILED_PRE
	accuracycheck BS_MOVE_MISSED 0x0
	attackstring
...
RoostBS:
	setdamageasrestorehalfmaxhp 0x81BBD8D 0x1 @;BattleScript_AlreadyAtFullHp
...
PurifyHeal:
	...
	setdamageasrestorehalfmaxhp 0x81BBD8D 0x1
...
BS_037_SetRest:
	...
	attackstring
	ppreduce
	jumpifstatus BANK_ATTACKER, STATUS_SLEEP, 0x81BAE7E @;BattleScript_RestIsAlreadyAsleep
	setrest 0x0
	pause DELAY_HALFSECOND
	printfromtable 0x83C452E @;gRestUsedStringIds
	waitmessage DELAY_1SECOND
	refreshhpbar BANK_ATTACKER
	waitstateatk
	goto 0x81BBD73 @;BattleScript_PresentHealTarget
...
AutotomizeBS:
	...
	attackstring
	ppreduce
	statbuffchange STAT_ATTACKER | STAT_BS_PTR | STAT_CERTAIN 0x81BAB88
	jumpifbyte EQUALS MULTISTRING_CHOOSER 0x2 0x81BAB6E
	attackanimation
	waitanimation
	setgraphicalstatchangevalues
	playanimation BANK_ATTACKER ANIM_STAT_BUFF ANIM_ARG_1
...
BS_061_LowerTargetSpAtk2:
	...
	jumpifnotmove MOVE_CAPTIVATE 0x81BABCF
...
BatonPassSwitchOutBS:
	...
	jumpifnotmove MOVE_BATONPASS 0x81BA913 @;U-Turn & Volt Switch
	goto BS_MOVE_END
...
UTurnCheckSwitchBS:
	copybyte SWITCHING_BANK USER_BANK
	jumpifcannotswitch BANK_SWITCHING | ATK4F_DONT_CHECK_STATUSES 0x81BA913
	jumpifnoviablemonsleft BANK_TARGET 0x81BA913
	jumpiffainted BANK_SWITCHING 0x81BA913
...
BS_132_MorningSun:
	...
	attackstring
	ppreduce
	recoverbasedonsunlight 0x81BBD8D @;AlreadyAtFullHp
	goto 0x81BAD82 @;Part of Recover
...
BS_143_PsychUp:
	jumpifnotmove MOVE_SPECTRALTHIEF 0x81BBA30
...
BS_156_DefenseCurl:
	...
	setcurled
	setstatchanger STAT_DEF | INCREASE_1
	statbuffchange STAT_ATTACKER | STAT_BS_PTR | STAT_CERTAIN 0x81BAB78
	jumpifbyte EQUALS MULTISTRING_CHOOSER 0x2 0x81BAB80
	attackanimation
	waitanimation
	goto 0x81BAB78
...
BS_161_SpitUp:
	attackcanceler
	jumpifbyte EQUALS, BATTLE_COMMUNICATION + 6, 0x1 0x81BBE34
	accuracycheck BS_MOVE_MISSED 0x0
	attackstringnoprotean
	ppreduce
	stockpiletobasedamage 0x81BBE26 @;Spit Up Fail
	tryactivateprotean
	call STANDARD_DAMAGE+2
	seteffectwithchancetarget
	prefaintmoveendeffects 0x0
...
BS_162_Swallow:
	...
	attackstringnoprotean
	ppreduce
	stockpiletohprecovery 0x81BBE54
	tryactivateprotean
	attackanimation
	waitanimation
	orword HIT_MARKER HITMARKER_IGNORE_SUBSTITUTE
...
PsychoShiftBS:
	...
	attackstringnoprotean
	ppreduce
	jumpifsideaffecting BANK_TARGET SIDE_SAFEGUARD 0x81BCAF5 @;Protected By Safeguard
...
BS_210_WaterSport:
	...
	attackanimation
	waitanimation
	printfromtable 0x83C45AC @;gSportsUsedStringIds
	waitmessage DELAY_1SECOND
	goto BS_MOVE_END
...
BS_203_NobleRoar:
	...
	accuracycheck BS_MOVE_MISSED + 2 0x0
	setbyte STAT_ANIM_PLAYED 0x0
	jumpifstatcanbelowered BANK_TARGET STAT_ATK NobleRoar_Atk
	jumpifstatcanbelowered BANK_TARGET STAT_SPATK NobleRoar_Atk
	pause 0x10
	goto NobleRoar_SkipAnim
...
NobleRoar_SkipAnim:
	...
	playstatchangeanimation BANK_TARGET, STAT_ANIM_ATK STAT_ANIM_DOWN
	setstatchanger STAT_ATK | DECREASE_1
	statbuffchange STAT_TARGET | STAT_BS_PTR NobleRoar_SpAtk
	jumpifbyte EQUALS MULTISTRING_CHOOSER 0x3 NobleRoar_SpAtk
	jumpifbyte EQUALS MULTISTRING_CHOOSER 0x4 BS_MOVE_END
	printfromtable gStatDownStringIds
	waitmessage DELAY_1SECOND
...
ReflectTypeString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0xFD, 0x10, 0x14, 0xFA, 0x05, 0x15, 0x3D, 0x60, 0x52, 0x9D, 0x16, 0x00, 0x15, 0x50, 0x10, 0xAB, 0xFF
PurifyString: .byte 0xFD, 0x10, 0x19, 0x00, 0xFD, 0x00, 0x1A, 0xFE, 0x07, 0x2A, 0x02, 0x0B, 0x50, 0x4B, 0x28, 0x00, 0x15, 0x08, 0x15, 0x50, 0x10, 0xAB, 0xFF
BecameNimbleString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0x20, 0x37, 0x29, 0x16, 0x15, 0x50, 0x10, 0xAB, 0xFF
FreezeShockChargingString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0x12, 0x22, 0x10, 0x02, 0x00, 0x1B, 0x06, 0x28, 0x16, 0x00, 0x12, 0x12, 0x1F, 0x2A, 0x10, 0xAB, 0xFF
IceBurnChargingString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0x0A, 0x3B, 0x04, 0x29, 0x00, 0x08, 0x03, 0x07, 0x16, 0x00, 0x12, 0x12, 0x1F, 0x2A, 0x10, 0xAB, 0xFF
ShadowForceString: .byte 0xFD, 0x0F, 0x19, 0x00, 0x0D, 0x37, 0x10, 0x37, 0xFE, 0x02, 0x50, 0x0C, 0x35, 0x2E, 0x16, 0x0C, 0x13, 0x00, 0x07, 0x04, 0x10, 0xAB, 0xFF
LaserFocusString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0x0E, 0x02, 0x0C, 0x2E, 0x2D, 0x00, 0x14, 0x38, 0x0D, 0x1F, 0x0C, 0x10, 0xAB, 0xFF
BurnUpString: .byte 0xFD, 0x0F, 0x19, 0xFE, 0x1E, 0x19, 0x05, 0x1A, 0x00, 0x23, 0x04, 0x12, 0x07, 0x10, 0xAB, 0xFF
UTurnString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0xFD, 0x39, 0x19, 0x23, 0x14, 0x1D, 0x00, 0x23, 0x45, 0x50, 0x13, 0x02, 0x08, 0xAB, 0xFF
RemoveFogString: .byte 0xFD, 0x0F, 0x1A, 0x00, 0xFD, 0x14, 0x44, 0xFE, 0x1C, 0x06, 0x02, 0x07, 0x28, 0x2D, 0x00, 0x1C, 0x07, 0x14, 0x46, 0x0C, 0x10, 0xAB, 0xFF
SpectralThiefString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0x01, 0x37, 0x50, 0x10, 0x00, 0x19, 0x03, 0x28, 0x36, 0x08, 0x2D, 0x00, 0x03, 0x46, 0x02, 0x14, 0x50, 0x10, 0xAB, 0xFF
StockpileWoreOffString: .byte 0xFD, 0x0F, 0x37, 0xFE, 0x10, 0x08, 0x2C, 0x04, 0x13, 0x02, 0x10, 0x00, 0x0A, 0x03, 0x06, 0x37, 0x00, 0x07, 0x2A, 0x10, 0xAB, 0xFF
BestowString: .byte 0xFD, 0x10, 0x1A, 0xFE, 0xFD, 0x0F, 0x06, 0x27, 0xFA, 0xFD, 0x16, 0x2D, 0x00, 0x03, 0x09, 0x14, 0x50, 0x10, 0xAB, 0xFF
AquaRingSetString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0x20, 0x3E, 0x19, 0x78, 0x7E, 0x89, 0x2D, 0x00, 0x1F, 0x14, 0x50, 0x10, 0xAB, 0xFF
CantUseHyperspaceFuryString:
CantUseMoveString: .byte 0xFD, 0x0F, 0x16, 0x1A, 0xFE, 0x12, 0x06, 0x03, 0x0A, 0x14, 0x37, 0x00, 0x44, 0x07, 0x15, 0x06, 0x50, 0x10, 0xAB, 0xFF
WrongHoopaFormString: .byte 0x02, 0x1F, 0x19, 0x00, 0xFD, 0x0F, 0x16, 0x1A, 0xFE, 0x12, 0x06, 0x03, 0x0A, 0x14, 0x37, 0x00, 0x44, 0x07, 0x15, 0x06, 0x50, 0x10, 0xAB, 0xFF
PsychoShiftString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0x3D, 0x36, 0x03, 0x10, 0x02, 0x02, 0x3D, 0x36, 0x03, 0x2D, 0xFA, 0xFD, 0x10, 0x16, 0x00, 0x03, 0x12, 0x0C, 0x10, 0xAB, 0xFF
GeomancyChargeString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0x9B, 0x7C, 0xAE, 0x2D, 0x00, 0x10, 0x22, 0x0A, 0x2E, 0x44, 0x02, 0x29, 0xAB, 0xFF
PowerHerbString: .byte 0xFD, 0x0F, 0x1A, 0x00, 0x9B, 0x7C, 0x6C, 0x79, 0x6A, 0xAE, 0x98, 0x44, 0xFE, 0x11, 0x06, 0x27, 0x37, 0x00, 0x20, 0x15, 0x38, 0x50, 0x10, 0xAB, 0xFF
PowerTrickString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0x0A, 0x03, 0x3A, 0x07, 0x14, 0x00, 0x4A, 0x03, 0x38, 0x36, 0x2D, 0x00, 0x02, 0x2A, 0x06, 0x04, 0x10, 0xAB, 0xFF
PowerSwapString: .byte 0xFD, 0x0F, 0x1A, 0x00, 0x01, 0x02, 0x13, 0x14, 0x3D, 0x48, 0x2E, 0x19, 0xFE, 0x0A, 0x03, 0x3A, 0x07, 0x14, 0x00, 0x14, 0x08, 0x0A, 0x03, 0x19, 0xFA, 0x19, 0x03, 0x28, 0x36, 0x08, 0x1D, 0x2E, 0x06, 0x2D, 0x00, 0x02, 0x2A, 0x06, 0x04, 0x10, 0xAB, 0xFF
GuardSwapString: .byte 0xFD, 0x0F, 0x1A, 0x00, 0x01, 0x02, 0x13, 0x14, 0x3D, 0x48, 0x2E, 0x19, 0xFE, 0x4A, 0x03, 0x38, 0x36, 0x14, 0x00, 0x14, 0x08, 0x4A, 0x03, 0x19, 0xFA, 0x19, 0x03, 0x28, 0x36, 0x08, 0x1D, 0x2E, 0x06, 0x2D, 0x00, 0x02, 0x2A, 0x06, 0x04, 0x10, 0xAB, 0xFF
SpeedSwapString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0x05, 0x10, 0x37, 0x02, 0x19, 0x00, 0x5D, 0x9C, 0xAE, 0x95, 0x2D, 0x00, 0x02, 0x2A, 0x06, 0x04, 0x10, 0xAB, 0xFF
HeartSwapString: .byte 0xFD, 0x0F, 0x1A, 0x00, 0x01, 0x02, 0x13, 0x14, 0x3D, 0x48, 0x2E, 0x19, 0xFE, 0x19, 0x03, 0x28, 0x36, 0x08, 0x1D, 0x2E, 0x06, 0x2D, 0x00, 0x02, 0x2A, 0x06, 0x04, 0x10, 0xAB, 0xFF
PowerSplitString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0x05, 0x10, 0x37, 0x02, 0x19, 0x9B, 0x7C, 0xAE, 0x2D, 0x00, 0x5C, 0x82, 0x51, 0x0C, 0x10, 0xAB, 0xFF
GuardSplitString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0x05, 0x10, 0x37, 0x02, 0x19, 0x87, 0xAE, 0x95, 0x2D, 0x00, 0x5C, 0x82, 0x51, 0x0C, 0x10, 0xAB, 0xFF
PledgeReadyString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0xFD, 0x13, 0x2D, 0x00, 0x1F, 0x50, 0x13, 0x02, 0x29, 0xB0, 0xFF
PledgeCombinedString: .byte 0xFD, 0x0F, 0x19, 0xFE, 0xFD, 0x14, 0xAB, 0xFB, 0xA3, 0x12, 0x19, 0x2C, 0x3C, 0x37, 0x00, 0xA2, 0x12, 0x16, 0x15, 0x50, 0x10, 0xAB, 0xFE, 0x5A, 0x7E, 0x97, 0x68, 0xAE, 0x5C, 0x86, 0x7E, 0x2C, 0x3C, 0x41, 0xAB, 0xFF
SwampString: .byte 0xFD, 0x35, 0x00, 0x1F, 0x2C, 0x28, 0x16, 0xFE, 0x0C, 0x12, 0x3A, 0x2E, 0x37, 0x00, 0x1B, 0x2B, 0x37, 0x50, 0x10, 0xAB, 0xFF
SeaOfFireString: .byte 0xFD, 0x35, 0x00, 0x1F, 0x2C, 0x28, 0x37, 0xFE, 0x1B, 0x19, 0x03, 0x20, 0x16, 0x00, 0x12, 0x12, 0x1F, 0x2A, 0x10, 0xAB, 0xFF
RainbowString: .byte 0xFD, 0x36, 0x0F, 0x27, 0x16, 0x00, 0x16, 0x3D, 0x37, 0x00, 0x06, 0x06, 0x50, 0x10, 0xAB, 0xFF
FlingString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0xFD, 0x16, 0x2D, 0x00, 0x15, 0x3A, 0x12, 0x09, 0x10, 0xAB, 0xFF
ProtectLiftedString: .byte 0xFD, 0x10, 0x19, 0xFE, 0x1F, 0x23, 0x28, 0x37, 0x00, 0x08, 0x3E, 0x2A, 0x10, 0xAB, 0xFF
HealBlockSetString: .byte 0xFD, 0x10, 0x1A, 0xFE, 0x06, 0x02, 0x1C, 0x08, 0x45, 0x03, 0x0B, 0x2D, 0x00, 0x1C, 0x03, 0x3D, 0x27, 0x2A, 0x10, 0xAB, 0xFF
EmbargoSetString: .byte 0xFD, 0x10, 0x16, 0x1A, 0xFE, 0x45, 0x03, 0x39, 0x37, 0x00, 0x12, 0x06, 0x04, 0x15, 0x08, 0x15, 0x50, 0x10, 0xAB, 0xFF
PowderSetString: .byte 0xFD, 0x10, 0x16, 0xFE, 0x1C, 0x2E, 0x3D, 0x2E, 0x2D, 0x00, 0x01, 0x47, 0x0E, 0x10, 0xAB, 0xFF
TelekinesisSetString: .byte 0xFD, 0x10, 0x2D, 0xFE, 0x11, 0x35, 0x03, 0x16, 0x00, 0x03, 0x06, 0x0E, 0x10, 0xAB, 0xFF
HealBlockTargetString: .byte 0xFD, 0x10, 0x1A, 0xFE, 0x06, 0x02, 0x1C, 0x08, 0x1C, 0x03, 0x3D, 0x44, 0x00, 0x06, 0x02, 0x1C, 0x08, 0x44, 0x07, 0x15, 0x02, 0xAB, 0xFF
ElectrifyString: .byte 0xFD, 0x10, 0x1A, 0x00, 0x0F, 0x03, 0x44, 0x2E, 0x44, 0xFE, 0x2C, 0x3C, 0x37, 0x00, 0x44, 0x2E, 0x07, 0x60, 0x52, 0x9D, 0x16, 0x15, 0x50, 0x10, 0xAB, 0xFF
TopsyTurvyString: .byte 0xFD, 0x10, 0x1A, 0xFE, 0x19, 0x03, 0x28, 0x36, 0x08, 0x1D, 0x2E, 0x06, 0x37, 0x00, 0x1B, 0x50, 0x08, 0x28, 0x06, 0x04, 0x50, 0x10, 0xAB, 0xFF
AfterYouString: .byte 0xFD, 0x10, 0x1A, 0xFE, 0x05, 0x0A, 0x14, 0x46, 0x16, 0x00, 0x01, 0x1F, 0x04, 0x29, 0x0A, 0x14, 0x16, 0x0C, 0x10, 0xAB, 0xFF
QuashString: .byte 0xFD, 0x10, 0x19, 0xFE, 0x3D, 0x35, 0x2E, 0x46, 0x2E, 0x2D, 0x00, 0x0B, 0x07, 0x05, 0x08, 0x28, 0x0C, 0x10, 0xAB, 0xFF
MagnetRiseSetString: .byte 0xFD, 0x0F, 0x1A, 0xFE, 0x44, 0x2E, 0x3D, 0x28, 0x36, 0x08, 0x44, 0x00, 0x03, 0x06, 0x47, 0x01, 0x37, 0x50, 0x10, 0xAB, 0xFF
FlameBurstString: .byte 0xFD, 0x13, 0x16, 0x23, 0xFE, 0x1B, 0x46, 0x15, 0x37, 0x00, 0x1C, 0x28, 0x06, 0x06, 0x50, 0x10, 0xAB, 0xFF
