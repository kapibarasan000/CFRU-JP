...
.equ Systemcript_BufferPocketNameTryFanfare, 0x8193F88
.equ SystemScript_NoRoomToPickUpItem, 0x81940F9
...
SystemScript_PickUpItem:
	...
	compare 0x8008 0x1
	if equal _call 0x81940ED
	compare 0x8008 0x0
	if equal _call SystemScript_FindNormalItem
	waitfanfare
	waitmsg
	msgbox 0x81930B4 MSG_KEEPOPEN 
...
SystemScript_ObtainItemMessage:
	...
	waitfanfare
	waitmsg
	msgbox 0x81930B4 MSG_KEEPOPEN @;[PLAYER] put the item in the...
...
ObtainedRegularItem:
	preparemsg 0x819309D @;Obtained the item!
	return
...
SystemScript_PickedUpHiddenItem: @;Replaces 81A6885
	...
	compare 0x8006 1
	if equal _call 0x8194176 @;EventScript_FoundSingleHiddenItem
	compare 0x8006 1
	if notequal _call 0x8194186 @;EventScript_FoundMultipleHiddenItems
	waitfanfare
	waitmsg
	msgbox 0x81930B4 MSG_KEEPOPEN @;gText_PutItemAway
...
EventScript_UseRockClimb_Ask:
	...
	msgbox 0x81A47C3 MSG_NORMAL @;[BUFFER1] used [BUFFER2]!
...
EventScript_UseWaterfall_Ask:
	msgbox 0x81A4A3B MSG_YESNO
	compare LASTRESULT NO
	if equal _goto EventScript_WaterfallEnd
	lockall
	call FollowerIntoPlayerScript
	callasm HideFollower
	msgbox 0x81A47C3 MSG_KEEPOPEN
